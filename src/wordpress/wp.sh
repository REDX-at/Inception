...
# wp user create $SECONDARY_USER $SECONDARY_MAIL --role=$SECONDARY_ROLE --user_pass=$SECONDARY_PASSWORD --allow-root
...
wp user create $SECONDARY_USER $SECONDARY_MAIL --role=$SECONDARY_ROLE --user_pass=$(cat /run/secrets/user_password) --allow-root
